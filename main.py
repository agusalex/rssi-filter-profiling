...
if __name__ == '__main__':
    ...
    _C, _n, _residual = find_coeficient(_steps, _signal_median)
    ...
    _distance_infered_median = rssi_to_distance(_signal_median, _C, _n)
    ...
    plot_signals([_distance_infered, rssi_to_distance(_log_of_distance_raw, _C, _n)],
                 ...
                 title="Inverse log, C=" + str(
        _C) + " N= " + str(_n) + " R%= " + str(_residual),
                 xi=_distance)
    ...
    plot_signals([_distance_infered_median, rssi_to_distance(_log_of_distance_discrete, _C, _n)],
                 ...
                 ylabel="Distance", title="Inverse Median C=" + str(
        _C) + " N= " + str(_n) + " R%= " + str(_residual))
